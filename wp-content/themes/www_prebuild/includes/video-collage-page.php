	...
	<?	// lay out videos
		...
		if($vgallery) {
			foreach($vgallery as $vg) { 
				$curr_col = ($curr_col<3)?($curr_col+1):0; // toggle column
				
				$buf = '
				<div class="videoGalleryColSlide">
					<div class="video">
						<iframe width="500" height="300" src="https://www.youtube.com/embed/'.$vg['video_id'].'?rel=0" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
				';
