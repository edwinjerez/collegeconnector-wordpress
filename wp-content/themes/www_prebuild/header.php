                                            ...
                                            <div class="collapse navbar-collapse">
                                                ...
                                                <div id="Mmenu" class="SpeedyDropDown">
                                                    ...
                                                    <ul class="nav MegaMenu">
                                                        ...
                                                        $cur_link = 'cur-link-'.$cur_link . '/'; // current page link
                                                        
														foreach ($main_menu_items as $m_item){
                                                            $is_active = strpos($cur_link, $m_item['url']);
													?>

														<li class="<?php if ( ($num++) == 0) echo 'first parent'; if ($is_active) echo ' active current'; ?>">
