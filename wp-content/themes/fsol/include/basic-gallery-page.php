...
<div id="fullscreen-box">
	<div id="fs-photo-gallery">
		...
		<div id="gallery-rotator" class="cycle-slideshow basic" data-cycle-slides="> div" data-cycle-prev=".basic-gallery-controls .prev a" data-cycle-next=".basic-gallery-controls .next a" data-cycle-swipe="true">
			<div></div>
			<div></div>
		</div>
